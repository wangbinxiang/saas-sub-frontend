...
if (Foundation.MediaQuery.current === 'small') {
  const menuLi = $('#responsive-menu-ul li')
  if (menuLi.length) {
    let strikingNavigationHtml = ''
    for (let li of menuLi) {
      const text = $(li).text()
      const href = $(li).children().attr('href')
      strikingNavigationHtml += '<li><a href="' + href + '">' + text + '</a></li>'
    }
    $('#strikingNavigationUl').html(strikingNavigationHtml)
    $('#strikingNavigationDiv').show()
  }
}
