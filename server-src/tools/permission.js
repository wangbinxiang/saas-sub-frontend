...
export function verifyPermission (memberGroup, permissionKey, value) {
  ...
  return !(memberGroup.purview && memberGroup.purview[permissionKey] && lodash.isArray(memberGroup.purview[permissionKey]) && memberGroup.purview[permissionKey].indexOf(value) !== -1)
}
