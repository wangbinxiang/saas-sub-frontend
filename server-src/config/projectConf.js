...
export const PROJECT_APPLICATION_RULE_TEXT = 'text'
export const PROJECT_APPLICATION_RULE_CHECKBOX = 'checkbox'
export const PROJECT_APPLICATION_RULE_RADIO = 'radio'

export const PROJECT_APPLICATION_RULE_NAMES = {
  [PROJECT_APPLICATION_RULE_TEXT]: 'text',
  [PROJECT_APPLICATION_RULE_CHECKBOX]: 'checkbox',
  [PROJECT_APPLICATION_RULE_RADIO]: 'radio'
}
